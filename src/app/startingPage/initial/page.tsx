...
const Sidebar = () => {
  return (
    <div className="lg:flex flex-col justify-between lg:p-8 xl:p-12 w-full">
      <div className="flex items-center justify-start space-x-3 h-full w-full relative">
        <Image src="https://uploads-ssl.webflow.com/6344fe0ae449f96ce795b92b/647ec76544a6f43b1d261144_6.webp" alt="typof-logo" width={870}
    height={1160} className="
                width: 100%;
                max-width: 100px;
                height: auto;
      ...
      <div className="bg-white h-screen">
        <div className="md:flex md:flex-row w-full h-screen">
          ...
          <div className="absolute top-0 left-0 p-4">
            <Image src="/logo2.svg" alt="Logo" className="w-32 h-10" width={870}
    height={1160} />
          </div>
          {/* Main Content */}
